...
-----END RSA PRIVATE KEY-----)";
	...
	addTransport("0.0.0.0:4430", new HttpTransport(SslAcceptor::create, "0.0.0.0", 4430, certificate, key));
	addTransport("0.0.0.0:4301", new PacketTransport(SslAcceptor::create, "0.0.0.0", 4431, certificate, key));
	addTransport("0.0.0.0:4432", new WsTransport(SslAcceptor::create, "0.0.0.0", 4432, certificate, key));
