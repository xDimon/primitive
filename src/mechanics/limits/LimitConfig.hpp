...
public:
	...
	LimitConfig& operator=(const LimitConfig&) = delete; // Copy-assignment
	LimitConfig(LimitConfig&&) noexcept = delete; // Move-constructor
	LimitConfig& operator=(LimitConfig&&) noexcept = delete; // Move-assignment
